  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto" >
        <div className="flex flex-wrap md:text-left text-center order-first">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <img src="https://tse3.mm.bing.net/th?id=OIP.D-vj79W3QRrTrgW5u1D_LgHaD4&pid=Api&P=0&h=180" alt="" />
            </div>
        </div>
    ...
    <div className="bg-gray-200" style={{ backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : '', color: mode === 'dark' ? 'white' : '', }}>
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4" style={{ color: mode === 'dark' ? 'white' : '' }}>© 2024 Shop Easy —
                <a href="https://www.linkedin.com/in/yogesh-joshi-7678b9186/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank" style={{ color: mode === 'dark' ? 'white' : '' }}>Shop Easy</a>
            </p>
